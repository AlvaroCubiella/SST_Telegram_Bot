...
# Establecemos el webhook de Telegram
def set_telegram_webhook():
    try:
        # Establecer el webhook para que Telegram sepa a dónde enviar las actualizaciones
        bot.set_webhook(url=WEBHOOK_URL)
        logging.info("Webhook de Telegram configurado correctamente.")
...
if __name__ == "__main__":
    ...
    # Iniciar el servidor Flask para recibir el webhook
    logging.info(f"BOT SST Telegram iniciado versión {__version__}")
